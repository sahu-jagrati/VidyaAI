"""
update_dice_image_urls_batch3.py
=================================
Sets image_url for Dice Q16 and Q19.
  Q16 — same solid figure as Q14/Q15 (4 rotated positions)
  Q19 — net diagram + answer boxes
  Q17 — pure calculation, no figure
  Q18 — text-only clues, no figure
