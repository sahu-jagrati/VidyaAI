"""
update_dice_image_urls_batch6.py
=================================
Sets image_url for Dice Q27–Q36.
  Q30 — pure calculation, no figure needed
  All others have dice-position diagrams.
...
# Q30 is a pure-text calculation question — no image
IMAGE_MAP = {
    27: "dice_27.png",
    28: "dice_28.png",
    29: "dice_29.png",
