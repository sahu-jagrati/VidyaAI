...
// Assertion & Reason questions always have a fixed 5th option that is not
// stored as a DB column. We inject it here so the quiz renders 5 buttons and
// the correct_answer "E" highlights correctly.
const AR_OPTION_E =
...
const SUBJECTS = [
  ...
  },
  {
    ...
    topics: [
      ...
      { name: "Pair Formation", icon: "🔠" },
      { name: "Missing Number", icon: "❓" },
      { name: "Ranking", icon: "🥇" },
      { name: "Word-Based", icon: "🔤" },
      { name: "Classification", icon: "🔍" },
      { name: "Alphabet", icon: "🔤" },
      { name: "Inequality", icon: "⚖️" },
      { name: "Analytical Reasoning", icon: "🧠" },
      { name: "Assumptions", icon: "💭" },
      { name: "Assertion and Reason", icon: "🔍" },
      { name: "Calendar", icon: "📅" },
      { name: "Coded Equations", icon: "🔢" },
      { name: "Cause and Effect", icon: "🔗" },
      { name: "Course of Action", icon: "🎯" },
